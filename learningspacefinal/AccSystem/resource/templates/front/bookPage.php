<?php include TEMPLATE_FRONT . DS . "TermsAndConditions.php"; ?>
                                ...
                                <div class="col-md-12">
                                    <?php if (isset($_GET['id'])) { ?>
                                        <div data-toggle="tooltip" data-placement="top" title="Click to Read and Agree the Terms and Conditions">
                                            <button type="button" class="btn btn-sm" name="TermsConditions" data-target="#termsConditionsModal" data-toggle="modal">Accept Terms of Services <input type="checkbox"  onchange="document.getElementById('sendN').disabled = !this.checked;" /></button>
                                        </div>
                                        <br>
                                        <button type="submit" name="bookroom" disabled id="sendN" class=" btn btn-outline-success formbutton">Confirm Details</button>

                                    <?php } else { ?>
                                        <button disabled="" class=" btn btn-outline-success formbutton">Select a room for Booking</button>
                                    <?php } ?>
                                </div>
                            </div>
                        <?php } ?>
