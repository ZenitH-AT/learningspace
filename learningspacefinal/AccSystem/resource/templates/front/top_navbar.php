        ...
        <ul class="navbar-nav mr-auto">
           ...
           <?php
            ...
            <form class="form-inline mt-2 mt-md-0 js-signin-modal-trigger">
                <button class="btn btn-outline-success my-2 my-sm-0" data-toggle="collapse" data-target=".navbar-collapse.show" href="#0" style="margin-right: 15px;" data-signin="login">Sign in
                </button>
                ...
                <ul class="navbar-nav">
                    <li>
                        <a class="nav-link text-light" >
                            Welcome,   <?php echo ucfirst($_SESSION["firstname"]); ?></a>
                    </li>
                </ul>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropBox" style="">
                        ...
                        <li class="footer bg-dark text-light bg-dark myMenuUser">
                            <a class="text-light" href="../resource/logout.php">Sign Out</a>
                        </li>
