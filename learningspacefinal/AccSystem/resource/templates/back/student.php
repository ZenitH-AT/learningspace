...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb text-secondary ">
            <li class="breadcrumb-item text-secondary"><i class="fa fa-users"></i> Student records</li>  
        </ol>
    </div>
</div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                    <div class="modal-content">  
                        <div class="modal-header">
                            <h5 class="d-flex">Edit - <?php echo $row['studFirstName'] . ' ' . $row['studLastName'] ?></h5>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    First name
                                                    <input type="text" class="form-control" value="<?php echo $row['studFirstName'] ?>" id="firstName<?php echo $row['studID']; ?>" name="firstName<?php echo $row['studID']; ?>">
                                                </div>
                                                <div class="col-sm-6">
                                                    School
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    Middle name
                                                    <input type="text" class="form-control" value="<?php echo $row['studMiddleName'] ?>" id="middleName<?php echo $row['studID']; ?>" name="middleName<?php echo $row['studID']; ?>">
                                                </div>
                                                <div class="col-sm-6">
                                                    School address
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    Last name
                                                    <input type="text" class="form-control" value="<?php echo $row['studLastName'] ?>" id="lastName<?php echo $row['studID']; ?>" name="lastName<?php echo $row['studID']; ?>">
                                                </div>
                                                <div class="col-sm-6">
                                                    Country
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    Email
                                                    <input type="text" class="form-control" value="<?php echo $row['studEmail'] ?>" id="email<?php echo $row['studID']; ?>" name="email<?php echo $row['studID']; ?>">
                                                </div>
                                                <div class="col-sm-6">
                                                    City
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    Date of birth
                                                    <input type="text" class="form-control" value="<?php echo $row['studDOB'] ?>" id="dateOfBirth<?php echo $row['studID']; ?>" name="dateOfBirth<?php echo $row['studID']; ?>">
                                                </div>
                                                <div class="col-sm-6">
                                                    ID/passport number
                                                    <input type="text" class="form-control" value="<?php echo $row['id_passport'] ?>" id="idPassport<?php echo $row['studID']; ?>" name="idPassport<?php echo $row['studID']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    Phone number
                                                    <input type="text" class="form-control" value="<?php echo $row['studPhone'] ?>" id="phoneNumber<?php echo $row['studID']; ?>" name="phoneNumber<?php echo $row['studID']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-outline-info formbutton" style="float:right" name="editStudent<?php echo $row['studID']; ?>">Edit student</button>
