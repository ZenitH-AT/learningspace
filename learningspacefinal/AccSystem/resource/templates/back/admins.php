    ...
    <h1 class="h2">Administrators</h1>
            <div class="btn-toolbar mb-2 mb-md-0">
                <?php if($_SESSION['adminCategory'] == 1) { ?>
                        <button type="button" class="btn btn-info formbutton" data-toggle="modal" data-target="#adminAddingPopup"><i class="fa fa-user-plus"></i> Add admin</button>
                <?php } ?>
                    ...
                    <tr>
                        ...
                        <?php
                            ...
                            if($_SESSION['idadmin'] == $row['adminID'] && $_SESSION['idadmin'] != 1 ) { ?>
                                <td><button type="button" class="btn btn-info formbutton" data-toggle="modal" data-target="#adminPopup<?php echo $row['adminID']; ?>"><span class="fa fa-user-edit" style="color:white"></button></form></td>
                            <?php }  else if($_SESSION['idadmin'] == 1 ) { ?>
                                 <td><button type="button" class="btn btn-info formbutton" data-toggle="modal" data-target="#adminPopup<?php echo $row['adminID']; ?>"><span class="fa fa-user-edit" style="color:white"></button></form></td>
                            <?php }
                        ?>
                        ...
                        <?php
                            ...
                            <td><form method="post"><button class="btn btn-danger formbutton" name="removeAdmin<?php echo $row['adminID']; ?>" onclick="return confirm('Are you sure you want to remove <?php echo $row['adminFirstN'] ?> ?')"><span class="fas fa-times" style="color:white"></button></form></td>
                            <?php } ?>
                        ...
                        if(isset($_POST['removeAdmin' . $row['adminID']])){
                            query("DELETE FROM admin WHERE adminID = ". $row['adminID']." AND adminActive = '0' ");
