        ...
        <tbody> <?php
            ...
            while ($row = fetch_array($query)) { 
                ...
                <tr>
                    ...
                    <td><button type="button" class="btn btn-success formbutton" data-toggle="modal" data-target="#ticketPopup<?php echo $row['ticketID']; ?>"><span class="fa fa-comments" style="color:white"></button></form></td>
                    <td><form method="post"><button class="btn btn-info formbutton" name="closereopen<?php echo $row['ticketID']; ?>" onclick="return confirm('Are you sure you want to reopen <?php echo $row['ticketSubject'] ?>?')"><span class="fa fa-arrow-up" style="color:white"></button></form></td><?php
