<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto" style="width:45%;">
            <input class="form-control form-control-dark w-100" id="searchFilter" style="margin-left: 1%;" placeholder="Filter table" aria-label="Search" type="text">  
        </ul>
        <ul class="navbar-nav">
